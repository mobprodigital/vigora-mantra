...
<body>
        ...
        <div class="row">
          <div class="col-md-12">
            <p class='top-note'> <span class="note"> PLEASE NOTE:</span> Due to extremely high demand, there
              is
              limited supply of
              <span class="high-light"> Power Mantra</span>
              available. - As of
 ...
 <main>
  ...
  <div class="text-center mt-15">
								...
								<div class="clearfix m-b-20">
									<div class="w-46 fl">
										<div class="travel-values">
											Name
												<span> - </span><span class="value"><?php echo $name;?></span>
										</div>
									</div>
									...
									<div class="w-46 fl">
										<div class="travel-values">
											Email
												<span> - </span><span class="value"><?php echo $email;?></span>
										</div>
									</div>
									<div class="divider"></div>
									<div class="w-46 fl">
										<div class="travel-values">
											Phone
												<span> - </span><span class="value"><?php echo $contact;?></span>
										</div>
									</div>
									<div class="divider"></div>
									<div class="w-46 fl">
										<div class="travel-values">
											Address
												<span> - </span><span class="value"><?php echo $address;?>,&nbsp;<?php echo $city;?>, &nbsp;<?php echo $state;?>, &nbsp;<?php echo $pincode;?></span>
										</div>
									</div>
									<div class="divider"></div>
									<div class="w-46 fl">
										<div class="travel-values">
											Quantity
												<span> - </span><span class="value"><?php echo $quantity;?> &nbsp; Box</span>
										</div>
									</div>
									<div class="divider"></div>
	 ...
	 <?php if(isset($_POST['order_id'])){ ?>
			<div class="payment-block my-3">
			<div class="d-flex justify-content-center flex-grow-1 align-items-center">	
			<div>
			<form  action="https://vigormantra.com/power-payment-success.php" method="POST">
  ...
  <footer>
    <div class="footer">
      ...
      <div>© 2019 Power Mantra . All Rights Reserved.</div>
