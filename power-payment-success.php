 ...
 <main>
	<?php
		...
		if(isset($_POST['razorpay_payment_id'])){
				$link = mysqli_connect("localhost", "mojogmhi_xxxuser", "xxxuser@123") or print(mysqli_error()."error\n");
				mysqli_select_db($link,"mojogmhi_xxx_mantra") or die(mysqli_error()."\n"); 
                ...
                Order Id :- $orderId.<br>
                Product :- Power Mantra Pack of $exp_pord[0].<br>
                Quantity :- 1<br>
                Price :- $price.<br>
                Pincode :- $pincode.<br>
                ...
                $subject = "Your Power Mantra Products Order Confirmation (".$orderId.")";
                ...
                $mail->setFrom('dev@mojogamezone.com','Power Mantra');
          ...
          <div class="travelSumary">
						...
						<div class="clearfix">
							<div class="onward clearfix">
								<div class="clearfix m-b-20">
									<div class="tot-payable-cont p-3" style="justify-content: center; align-items: center; display: flex; flex-direction: column; min-height: 70vh; border: 1px solid lightgray;">
                    ...
                    <div class="d-flex flex-column align-items-center mt-3">
                      <div class="details-box"> 
                        <div class="w-46 fl">
                          <div class="travel-values"  style="font-weight: bold;">
                              Order ID
                              <span> - </span>
                              <span style="font-weight: bold; color: #007bff<?php echo $razorpay_order_id;?></span>
                          </div>
                        </div>
                        <div class="w-46 fl">
                          <div class="travel-values"  style="font-weight: bold;">
                            Payment ID
                              <span> - </span>
                              <span style="font-weight: bold; color: #007bff;"><?php echo $razorpay_payment_id;?></span>
                          </div>
                        </div>
                    </div>
                    </div>
