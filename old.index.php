                ...
                <fieldset id="fieldForm">
                  <div class="form-group">
                    <input data-validate data-required="Please Enter First Name"
                      data-type="alphabets_s;Only alphabets are allowed" data-err-id="fname-err" type="text"
                  ...
                  <div class="form-group">
                    <input data-validate data-required="Please Enter Phone Number"
                      ...
                      class="form-control" id="phone" name="phone" placeholder="Phone" onchange="getPhoneNumber()">
                  ...
                  <div class="form-group">
                    <input data-validate data-required="Please Enter Pincode" data-type="int;Only Numbers are allowed"
                      data-err-id="pincode-err" type="text" class="form-control" id="pincode" name="pincode"
                      placeholder="Pincode">
                        ...
                        <div class="col-md-8">
                          <div class="form-check form-check-inline">
                            <input checked class="form-check-input " type="radio" name="payment_type" id="payment_type1"
                              value='COD'>
                            <label class="form-check-label cursor-pointer" for="payment_type1">Cash on Delivery</label>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input " type="radio" name="payment_type" id="payment_type2"
                              value="Paytm">
                            <label class="form-check-label cursor-pointer" for="payment_type2">Paytm</label>
                          </div>
                        </div>
                      </div>
                      <div class="paytm-number" id="payment_type">
                        Please Make Payment on this Number
                        <span class="display-block"> 9811213186</span>
                      </div>
                    </div>
