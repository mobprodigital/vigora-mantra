 ...
 <main>
	<!-- <?php
		...
		if(isset($_POST['razorpay_payment_id'])){
				$link = mysqli_connect("localhost", "mojogmhi_slim", "q1w2@slimmantra") or print(mysqli_error()."error\n");
				mysqli_select_db($link,"mojogmhi_slim_mantra") or die(mysqli_error()."\n"); 
                ...
                Order Id :- $orderId.<br>
                Product :- Slim Mantra Pack of $exp_pord[0].<br>
                Quantity :- 1<br>
                Price :- $price.<br>
                Pincode :- $pincode.<br>
                ...
                $subject = "Your Slim Mantra Products Order Confirmation (".$orderId.")";
                ...
                $mail->setFrom('dev@mojogamezone.com','Slim Mantra');
